...
// });
    ...
    Route::middleware(['auth.jwt'])->group(function () {
        Route::get('/user', function () {
            ...
            Route::get('/checked-in-appointments', [AppointmentsController::class, 'checkedInAppointments']);

            Route::delete('/appointments/queue/{queueId}', [AppointmentsController::class, 'deleteFromQueue']);
